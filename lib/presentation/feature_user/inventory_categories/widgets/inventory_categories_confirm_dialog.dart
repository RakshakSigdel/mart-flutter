...
/// (removing a category, withdrawing a unit permission). Returns `true` if
/// confirmed, `null`/`false` otherwise — the caller performs the actual
/// action after awaiting this, so a thrown [ApiException] surfaces exactly
/// where the caller already handles it.
Future<bool?> showInventoryCategoryConfirmDialog(
